...
| | |
|---|---|
| ![](DocImages/challenge1.png) | ![](DocImages/challenge2.png) |
...
| Optional ledge to jump to | Heart pickups (presented in negative space)|
|---|---|
...
| Mix of positive and negative spaces | Positive space example |
|---|---|
